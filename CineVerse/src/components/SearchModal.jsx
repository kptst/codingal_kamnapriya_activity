// ════════════════════════════════════════════════════════════════════════════
// SearchModal.jsx — Full-screen movie search overlay
// ════════════════════════════════════════════════════════════════════════════

// ─────────────────────────── LESSON 4 START ──────────────────────────────
// Integrating APIs and Fetching Movie Data
// Goal   : Let users search any movie by title and view its details.
// Output : A search overlay with a results grid; clicking opens the detail modal.
//
// How it works:
//   1. User types a title and clicks Search
//   2. omdbSearch() calls the OMDb API with fetch()
//   3. Results render as a grid of poster cards
//   4. Clicking a card calls omdbDetails() then opens MovieModal
